...
const Events = () => {
  return (
    <div className="bg-black bg-primary flex flex-col justify-center items-center pt-[50px] pb-[50px] relative z-0 w-screen m-0">
      ...
      <div className="flex flex-wrap gap-[100px] items-center justify-center pt-12" >
